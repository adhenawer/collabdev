...
<div class="tipoRepositorios index">
    ...
    <tr>
        ...
        <td class="actions">
            <?php echo $this->Html->link(__('Visualizar'), array('action' => 'view', $tipoRepositorio['TipoRepositorio']['id'])); ?>
            <?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $tipoRepositorio['TipoRepositorio']['id'])); ?>
            <?php echo $this->Form->postLink(__('Deletar'), array('action' => 'delete', $tipoRepositorio['TipoRepositorio']['id']), null, __('Are you sure you want to delete # %s?', $tipoRepositorio['TipoRepositorio']['id'])); ?>
        </td>
    </tr>
<?php endforeach; ?>
    </table>
